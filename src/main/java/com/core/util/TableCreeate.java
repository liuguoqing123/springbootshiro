...
public class TableCreeate {
    public static Map<String, String> javaProperty2SqlColumnMap = new HashMap();

    static {
        javaProperty2SqlColumnMap.put("Integer", "Int(20)");//put("Integer", "INTEGER");
        ...
        javaProperty2SqlColumnMap.put("String", "VARCHAR(50)");
    }
    ...
    public static void main(String[] args) throws IOException {
        createTable(UserShrio.class, null);
